            ...
            <td>
              ...
              ${a.marcas_vigiladas ? `
                <div style="margin-top:8px; font-size:0.75rem; color:var(--text-secondary); background: rgba(0,0,0,0.02); padding: 4px; border-radius: 4px;">
                  ...
                  ${a.marcas_vigiladas.numero_acta ? `<br><a href="https://portaltramites.inpi.gob.ar/MarcasConsultas/Resultado?acta=${encodeURIComponent(a.marcas_vigiladas.numero_acta)}" target="_blank" style="text-decoration:underline;">Ver Acta ${UI.escapeHtml(a.marcas_vigiladas.numero_acta)} ↗</a>` : ''}
                </div>
              ` : ''}
            </td>
