  ...
  function render() {
    ...
    if (tbody) {
      tbody.innerHTML = filtered.map(a => {
        ...
        const enlace = a.enlace_inpi || `https://portaltramites.inpi.gob.ar/MarcasConsultas/Grilla?acta=${a.acta_nueva}`;
