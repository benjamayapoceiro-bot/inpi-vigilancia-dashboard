...
const NIZA = (() => {
    const CLASES = [
        ...
        { n: 9, titulo: "Software, electrónica y tecnología", kw: "software app aplicacion tecnologia electronico computadora celular programa plataforma digital" },
        ...
        { n: 25, titulo: "Ropa, calzado y sombrerería", kw: "ropa indumentaria calzado zapatilla sombrero moda vestimenta" },
        ...
        { n: 30, titulo: "Café, panificados, condimentos, dulces", kw: "cafe pan panaderia pasteleria dulce chocolate condimento harina helado pizza" },
        { n: 31, titulo: "Productos agrícolas y animales vivos", kw: "agricola semilla planta animal vivo fruta verdura fresca" },
        ...
        { n: 35, titulo: "Publicidad y gestión comercial", kw: "publicidad marketing venta comercio negocio gestion empresarial administracion tienda retail" },
        { n: 36, titulo: "Seguros y finanzas", kw: "seguro finanza banco inmobiliaria alquiler inversion credito inmueble propiedad" },
        { n: 37, titulo: "Construcción y reparación", kw: "construccion reparacion obra instalacion mantenimiento" },
        { n: 38, titulo: "Telecomunicaciones", kw: "telecomunicacion internet telefonia streaming transmision" },
        { n: 39, titulo: "Transporte y logística", kw: "transporte logistica envio delivery flete viaje turismo" },
        { n: 40, titulo: "Tratamiento de materiales", kw: "tratamiento material fabricacion a medida impresion 3d" },
        { n: 41, titulo: "Educación y entretenimiento", kw: "educacion capacitacion curso entretenimiento evento musica deporte cultura enseñanza" },
        { n: 42, titulo: "Servicios tecnológicos y de diseño", kw: "software desarrollo diseño ingenieria tecnologia investigacion cientifico web plataforma saas" },
        { n: 43, titulo: "Restaurantes y hospedaje", kw: "restaurante bar hotel hospedaje gastronomia cafeteria alojamiento" },
        { n: 44, titulo: "Servicios médicos y de belleza", kw: "medico salud belleza estetica peluqueria spa veterinario clinica" },
        { n: 45, titulo: "Servicios legales y de seguridad", kw: "legal juridico abogado seguridad procuracion notarial" },
    ];

    function sugerir(descripcion, top = 5) {
        ...
        const puntajes = CLASES.map(c => {
            ...
            for (const p of palabras) {
                for (const kw of kwList) {
                    if (kw.includes(p) || p.includes(kw)) score += 1;
                }
            }
            return { ...c, score };
        });
